    ...
    return (
        <>
            ...
            <main className="feminine-clothes">
                ...
                <h2>Camisas</h2>
                <div className="home-female-products">
                    {items.filter(item => item.register.category === "feminino" && item.register.type === "camisa").map(item => {
                        return (
                            <Link to={`/product/${item.register.id}`} key={item.register.category + item.register.itemName + item.register.id}>
                                <Picture
                                    image={item.register.image}
                ...
                <h2>Bolsas</h2>
                <div className="home-female-products">
                    {items.filter(item => item.register.category === "feminino" && item.register.type === "bolsa").map(item => {
                        return (
                            <Link to={`/product/${item.register.id}`} key={item.register.category + item.register.itemName + item.register.id}>
                                <Picture
                                    image={item.register.image}
                ...
                <h2>Sapatos</h2>
                <div className="home-female-products">
                    {items.filter(item => item.register.category === "feminino" && item.register.type === "sapato").map(item => {
                        return (
                            <Link to={`/product/${item.register.id}`} key={item.register.category + item.register.itemName + item.register.id}>
                                <Picture
                                    image={item.register.image}
